...
Comparison for [BLOCKED_ON_PLUGIN_MODULE_INIT_MS](https://dxr.mozilla.org/mozilla-central/search?q=BLOCKED_ON_PLUGIN_MODULE_INIT_MS+file%3AHistograms.json&redirect=true)/Shockwave Flash24.0.0.186 (with add-ons):
    ...
    17147 non-e10s profiles have this histogram.
    16844 e10s profiles have this histogram.
    16844 e10s profiles have the parent histogram.
    15733 e10s profiles have the children histogram.
...
![png](images/output_55_6.png)
    ...
    The probability that the distributions for BLOCKED_ON_PLUGIN_MODULE_INIT_MS (children) (with add-ons) are differing by chance is 0.071.
...
Comparison for [BLOCKED_ON_PLUGIN_INSTANCE_INIT_MS](https://dxr.mozilla.org/mozilla-central/search?q=BLOCKED_ON_PLUGIN_INSTANCE_INIT_MS+file%3AHistograms.json&redirect=true)/Shockwave Flash24.0.0.186 (with add-ons):
    ...
    17147 non-e10s profiles have this histogram.
    15733 e10s profiles have this histogram.
...
![png](images/output_55_10.png)
    ...
    The probability that the distributions for BLOCKED_ON_PLUGIN_INSTANCE_INIT_MS (children) (with add-ons) are differing by chance is 0.009.
...
Comparison for [BLOCKED_ON_PLUGIN_INSTANCE_DESTROY_MS](https://dxr.mozilla.org/mozilla-central/search?q=BLOCKED_ON_PLUGIN_INSTANCE_DESTROY_MS+file%3AHistograms.json&redirect=true)/Shockwave Flash24.0.0.186 (with add-ons):
    ...
    17053 non-e10s profiles have this histogram.
    15520 e10s profiles have this histogram.
    No e10s profiles have the parent histogram.
    15520 e10s profiles have the children histogram.
...
![png](images/output_55_14.png)
    ...
    The probability that the distributions for BLOCKED_ON_PLUGIN_INSTANCE_DESTROY_MS (children) (with add-ons) are differing by chance is 0.375.
...
Comparison for MEMORY_TOTAL (with add-ons):
    ...
    117534 non-e10s profiles have this histogram.
    115264 e10s profiles have this histogram.
    115264 e10s profiles have the parent histogram.
    No e10s profiles have the children histogram.
...
Comparison for MEMORY_VSIZE_MAX_CONTIGUOUS (with add-ons):
    ...
    115269 non-e10s profiles have this histogram.
    113552 e10s profiles have this histogram.
    113552 e10s profiles have the parent histogram.
    94039 e10s profiles have the children histogram.
...
Comparison for FX_TAB_SWITCH_TOTAL_MS (with add-ons):
    ...
    73693 non-e10s profiles have this histogram.
    72360 e10s profiles have this histogram.
    72360 e10s profiles have the parent histogram.
    No e10s profiles have the children histogram.
