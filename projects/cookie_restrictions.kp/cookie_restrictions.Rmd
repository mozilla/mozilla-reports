...
In Fig 1 it's hard to see the difference between branches, so in Fig 2 I plot the "uplift" of each cohort vs the control, Cohort_1. The "uplift" is the ratio of y values in Fig 1, minus 1: if the uplift is zero then there is no change, if it is positive then more users have >x active hours. I shade the 90% probability bands around each of these uplifts.
